...
def trash_message(message_id: str) -> Any:
    """
...
def list_messages(count: int) -> List[GmailMessage]:
    ...
    return _fetch_metadata_for_messages(list_response.get("messages", []))

def search_messages(query: str, count: int) -> List[GmailMessage]:
    """
